package com.example.crowdmeasure.presentation.ui.components.cards
 ...
 * Supports an optional leading icon in a circular container (Material 3 style).
 */
@Composable
...
/** Thin divider for separating logical groups within a section card. */
@Composable
